...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ( (results_stats_dic['n_correct_dog_matches'] + results_stats_dic['n_correct_nondog_matches'])
    ...
    if (print_incorrect_breed and 
        (results_stats_dic['n_correct_dog_matches'] != results_stats_dic['n_correct_breed_matches']) 
       ):
